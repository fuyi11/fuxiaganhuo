...
import com.dingmouren.fujialiangmvp.base.BaseFragment;
import com.dingmouren.fujialiangmvp.event.NightModeChangeEvent;
import com.dingmouren.fujialiangmvp.ui.about.AboutActivity;
import com.dingmouren.fujialiangmvp.ui.category.CategoryFragment;
import com.dingmouren.fujialiangmvp.ui.gallery.GalleryActivity;
import com.dingmouren.fujialiangmvp.ui.picture.WelfareFragment;
import com.dingmouren.fujialiangmvp.ui.reading.ReadingFragment;
import com.dingmouren.fujialiangmvp.ui.videos.VideosFragment;
import com.dingmouren.fujialiangmvp.ui.webdetail.WebDetailActivity;
import com.dingmouren.fujialiangmvp.util.MyGlideImageLoader;
import com.dingmouren.fujialiangmvp.util.SPUtil;
import com.dingmouren.fujialiangmvp.util.SnackbarUtils;
import com.dingmouren.fujialiangmvp.util.StatusBarUtil;
import com.dingmouren.fujialiangmvp.util.ViewUtils;
...
//    @BindView(R.id.fab_main)  FloatingActionButton mFab; 不显示这个小图标，以后留作他用
    ...
    private void setupNavView(){
        ...
        //博客点击跳转
        mNavView.getHeaderView(0).findViewById(R.id.linear_csdn).setOnClickListener((view)-> WebDetailActivity.newInstance(this,getResources().getString(R.string.csdn_url),"伏某人的CSDN"));
        mNavView.getHeaderView(0).findViewById(R.id.linear_github).setOnClickListener((view)->WebDetailActivity.newInstance(this,getResources().getString(R.string.github_url),"伏某人的github"));
    }
